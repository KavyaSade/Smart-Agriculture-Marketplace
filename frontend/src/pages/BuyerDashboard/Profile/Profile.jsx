              ...
              <div className="profile-minimal-column">
                ...
                <div className="profile-minimal-list">
                  ...
                  <div className="profile-minimal-item">
                    ...
                    <span className="profile-minimal-value">{profileData.phone || 'Not provided'}</span>
                  </div>
                  <div className="profile-minimal-item">
              ...
              <div className="profile-minimal-column">
                ...
                <div className="profile-minimal-list">
                  <div className="profile-minimal-item">
                    ...
                    <span className="profile-minimal-value">{profileData.addressStreet || 'Not provided'}</span>
                  </div>
                  <div className="profile-minimal-item">
                    <span className="profile-minimal-label">City</span>
                    <span className="profile-minimal-value">{profileData.addressCity || 'Not provided'}</span>
                  </div>
                  <div className="profile-minimal-item">
                    <span className="profile-minimal-label">State</span>
                    <span className="profile-minimal-value">{profileData.addressState || 'Not provided'}</span>
                  </div>
                  <div className="profile-minimal-item">
                    <span className="profile-minimal-label">Postal / PIN Code</span>
                    <span className="profile-minimal-value">{profileData.addressPin || 'Not provided'}</span>
                  </div>
                </div>
              </div>
            </div>
