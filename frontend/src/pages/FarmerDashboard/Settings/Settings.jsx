    ...
    <div className="section-card animate-fade-in">
      <div className="card-section-header">
        ...
        <p style={{ color: '#55625b', fontSize: '0.9rem', margin: '0.25rem 0 0 0' }}>
          Manage your store status, notifications, and application theme.
        </p>
      </div>
      ...
      <div className="settings-container-new" style={{ marginTop: '2rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div className="settings-group-card" style={{ background: '#ffffff', border: '1px solid rgba(82, 183, 136, 0.08)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(27, 67, 50, 0.02)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1b4332', margin: '0 0 0.25rem 0' }}>Store Operational Status</h3>
              <p style={{ color: '#64748b', fontSize: '0.85rem', margin: 0 }}>Temporarily close your digital storefront to stop receiving new orders.</p>
            </div>
            <label className="toggle-switch-wrapper" style={{ position: 'relative', display: 'inline-block', width: '50px', height: '26px' }}>
              <input 
                ...
                checked={isStoreOpen}
                onChange={(e) => {
                  setIsStoreOpen(e.target.checked);
                  logActivity(`Store status set to ${e.target.checked ? 'Open' : 'Closed'}`, 'info');
                }}
                style={{ opacity: 0, width: 0, height: 0 }} 
              />
              <span className="toggle-slider" style={{ position: 'absolute', cursor: 'pointer', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: isStoreOpen ? '#40916c' : '#ccc', transition: '0.4s', borderRadius: '34px' }}>
                <span className="toggle-circle" style={{ position: 'absolute', content: '""', height: '18px', width: '18px', left: isStoreOpen ? '28px' : '4px', bottom: '4px', backgroundColor: 'white', transition: '0.4s', borderRadius: '50%' }}></span>
              </span>
            </label>
          </div>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <p style={{ color: '#64748b', fontSize: '0.85rem', margin: 0 }}>Receive email confirmations when customers place new crop orders.</p>
              </div>
              <label className="toggle-switch-wrapper" style={{ position: 'relative', display: 'inline-block', width: '50px', height: '26px' }}>
                <input 
                  type="checkbox" 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <p style={{ color: '#64748b', fontSize: '0.85rem', margin: 0 }}>Receive instant SMS messages on your mobile when inventory stocks drop below limits.</p>
              </div>
              <label className="toggle-switch-wrapper" style={{ position: 'relative', display: 'inline-block', width: '50px', height: '26px' }}>
                <input 
                  type="checkbox" 
