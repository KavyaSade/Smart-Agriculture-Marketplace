...
import '../../AdminDashboard/Coupons/AdminCoupons.css'; // Reuse CSS styling for consistent design

export default function FarmerCoupons({ setAlert }) {
    ...
    <div className="admin-coupons-view">
      ...
      {filteredCoupons.length > 0 ? (
          ...
          <table className="custom-dashboard-table">
            <thead>
              <tr>
                ...
                <th className="text-dark">Applicable Products</th>
                  ...
                  <tr key={c._id}>
                    ...
                    <td>
                      <div className="targeting-summary">
                        ...
                        {!c.applicableProducts?.length && !c.applicableCategories?.length && (
                          <span className="global-badge" style={{ color: '#2d6a4f' }}>All My Products</span>
                        )}
                      </div>
                    </td>
                    <td>
        ...
        <div className="empty-state" style={{ padding: '3rem 1rem' }}>
          <span className="empty-state-text">You haven't created any coupons yet.</span>
        </div>
      )}
          ...
          <div className="modal-card-custom animate-fade-in">
            ...
            <form onSubmit={handleCreateCoupon} className="modal-form-custom">
              ...
              <div className="targeting-selectors-group">
                <h4>Restrict Coupon Targeting (Optional: Applies to all your products otherwise)</h4>
                
                <div className="targeting-flex">
                  <div className="selector-box" style={{ gridColumn: 'span 1' }}>
                  ...
                  <div className="selector-box" style={{ gridColumn: 'span 2' }}>
                    <h5>Restrict to My Products</h5>
                    <div className="checkbox-list select-list" style={{ maxHeight: '180px' }}>
                      {myProducts.map(p => (
      ...
      {showUsageModal && selectedUsage && (
        <div className="modal-overlay-custom">
          <div className="modal-card-custom usage animate-fade-in">
            <div className="modal-header-custom">
              <h3>My Coupon Performance ({selectedUsage.code})</h3>
            ...
            <div className="usage-stats-grid">
              ...
              <div className="usage-stat-card">
                <span className="stat-label">My Sales Generated</span>
                <span className="stat-value">₹{(selectedUsage.totalSales || 0).toLocaleString()}</span>
              </div>
              <div className="usage-stat-card">
                <span className="stat-label font-bold">Discounts Sponsored By Me</span>
                <span className="stat-value">₹{(selectedUsage.totalDiscount || 0).toLocaleString()}</span>
              </div>
            </div>

            <h4 style={{ margin: '1.5rem 0 0.75rem 0', color: '#1b4332' }}>Coupon Customer Ledger</h4>
            {selectedUsage.orders?.length > 0 ? (
              ...
              <div className="text-muted" style={{ padding: '1rem 0' }}>This coupon hasn't been applied to any of your orders yet.</div>
            )}
