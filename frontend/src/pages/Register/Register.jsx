...
export default function Register() {
  ...
  // track selected registration role in a ref to avoid closure capture issues in callbacks
  const roleRef = useRef(formData.role);
  useEffect(() => {
    roleRef.current = formData.role;
  }, [formData.role]);

  // handler when user clicks sign up with google
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // call firebase registration from context
