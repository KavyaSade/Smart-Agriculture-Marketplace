...
export default function Profile({ profile, setProfile, profilePhoto, setProfilePhoto, setAlert }) {
  ...
  const handlePhotoChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setAlert({ type: 'success', text: 'Admin profile photo updated!' });
      };
  ...
  const handleProfileSubmit = (e) => {
    e.preventDefault();
    setAlert({ type: 'success', text: 'Admin details saved successfully!' });
  };
    ...
    <div className="profile-view dashboard-card">
      <form onSubmit={handleProfileSubmit}>
        ...
        <div className="form-grid-layout">
          ...
          <div className="form-group">
            <label className="form-label text-dark">Office Location</label>
            <input
              type="text"
              className="form-input"
          ...
          <div className="form-group form-group-full">
            <label className="form-label text-dark">Admin Bio</label>
            <textarea
              rows="3"
